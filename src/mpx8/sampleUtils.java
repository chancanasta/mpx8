...
{
	public String InNames[]=new String[8];
	public String OutNames[]=new String[8];
	public String FinalName[]=new String[8];
...
//first thing, split the name
		...
		String workName=splitArray[0];
		String workString=null;
		if(workName.length()<=8)
		{
			workString=outDir+inFile;
			FinalName[idx]=inFile;
		}
		else
		{
...
//check for 16 bits
		...
		AudioSystem.write(targetStream, targetFileType, targetFile);
		return 0;
	}
}
